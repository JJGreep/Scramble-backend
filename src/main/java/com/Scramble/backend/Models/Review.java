...
public class Review {
    ...
    public Review(Number rating, String review_text, int id, String rating_color, String review_time_friendly, String rating_text, int timestamp, int likes, User user, int comments_count) {
        this.rating = rating;
        this.review_text = review_text;
        this.id = id;
        this.rating_color = rating_color;
