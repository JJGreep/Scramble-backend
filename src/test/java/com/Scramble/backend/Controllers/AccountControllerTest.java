...
class AccountControllerTest {
    ...
    void testCreateAccount() throws Exception{
        ...
        List<RestaurantDb> favRestaurants = new ArrayList<RestaurantDb>();
        List<RestaurantDb> history = new ArrayList<RestaurantDb>();
        Account newAccount = new Account("test@test.nl", eatGroups, "Test", "test", favRestaurants, history);

        when(accountRepo.save(newAccount)).thenReturn(newAccount);

        //When
        Account account = accountController.createAccount(newAccount);

        //Then
        verify(accountRepo).save(newAccount);
        assertThat(account,is(equalTo(newAccount)));
    }
